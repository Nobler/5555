...
public class MainService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        ComponentName deviceAdmin = new ComponentName(this, MainSettingsActivity.AdminReceiver
                .class);
        ...
        registerReceiver(mReceiver = new SensorEventReceiver(sm, s, dpm, deviceAdmin), filter);
